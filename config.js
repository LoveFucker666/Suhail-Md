...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "LoveFucker",
  ownername:process.env.OWNER_NAME|| "AYanAkuma",
  ...
  HEROKU_APP_NAME:process.env.HEROKU_APP_NAME|| "love_fucker_akuma_ayaan",
  antilink_values:process.env.ANTILINK_VALUES|| "all",
  HEROKU: process.env.Love_Fucker_akuma_Ayan && process.env.HEROKU_API_KEY,
